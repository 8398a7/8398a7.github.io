...
const gymkhanaResults = [
  {
    title: '2010 愛媛DUNLOP杯#スペシャルN',
    date: '2010/04/25',
    result: '21/30 (121.14%) (first run)',
  },
  {
    title: '2011 愛媛DUNLOP杯#スペシャルN',
    date: '2011/04/24',
    result: '1/26 (100.0%)',
  },
  {
    title: '2011 DUNLOP杯#JAPAN',
    date: '2011/10/09',
    result: '65/190 (108.91%)',
  },
  {
    title: '2011 近畿DUNLOP杯#2',
    date: '2011/12/11',
    result: '4/42 (102.53%)',
  },
      ...
      <div className="grid gap-6">
        <div className="video-container">
          <iframe
            width="560"
            height="315"
            src="https://www.youtube.com/embed/dK9cjCwVTys?si=_TsLi-9Cw8Y1vbtm"
        ...
        <div className="video-container">
          <iframe
            width="560"
            height="315"
            src="https://www.youtube.com/embed/6-_uiBqEP-M?si=KeGHMhZe34aDOc6O"
            title="YouTube video player"
            frameBorder="0"
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
            referrerPolicy="strict-origin-when-cross-origin"
